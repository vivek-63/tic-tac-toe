...
A simple Tic Tac Toe game built using HTML, CSS, and JavaScript. This project is designed to help beginners understand core JavaScript concepts through a fun, interactive game.
...
Basic UI updates using JavaScript
